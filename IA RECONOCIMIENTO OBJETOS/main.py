...
showCap=False #ESTA CAMBIALA A TRUE PARA ABRIR LA CAMARA
...
while True:
    ...
    else: img=cv2.imread('silvio.jpeg') #ACA LE METES LA FOTO QUE QUIERAS EN LA CARPETA Y CON
                                  #Y CON LA CAMARA EN FALSE LE REEMPLAZAS EL NOMBRE POR LA IMAGEN QUE QUIERAS
    ...
    #PARA EJECUTAR PONE EN LA CONSOLA py main.py y con CTRL + C LO CERRAS
